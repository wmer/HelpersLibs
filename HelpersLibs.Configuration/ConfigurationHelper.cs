...
namespace HelpersLibs.Configuration {
    public class ConfigurationHelper {
        public static T GetConfiguration<T>(string? sectionName = null, string? pathConfigFile = null, string configFileName = "appsettings.json", bool optional = false) {
        ...
        public static string GetValue(string key, string configFileName = "appsettings.json") {
